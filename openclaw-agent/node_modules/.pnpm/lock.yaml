...
importers:
  ...
  apps/agent-daemon:
    dependencies:
      '@havenclaw/contract-client':
        specifier: workspace:*
        version: link:../../packages/contract-client
      '@havenclaw/decision':
        specifier: workspace:*
        version: link:../../packages/decision
      '@havenclaw/governance':
        specifier: workspace:*
        version: link:../../packages/governance
      '@havenclaw/haven-interface':
        specifier: workspace:*
        version: link:../../packages/haven-interface
      '@havenclaw/identity':
        specifier: workspace:*
        version: link:../../packages/identity
      '@havenclaw/learning':
        specifier: workspace:*
        version: link:../../packages/learning
      '@havenclaw/memory':
        specifier: workspace:*
        version: link:../../packages/memory
      '@havenclaw/reasoning':
        specifier: workspace:*
        version: link:../../packages/reasoning
      '@havenclaw/runtime':
        specifier: workspace:*
      ...
      '@havenclaw/transaction':
        specifier: workspace:*
        version: link:../../packages/transaction
      commander:
        specifier: ^11.1.0
        version: 11.1.0
      ethers:
  ...
  packages/tests:
    ...
    devDependencies:
      ...
      '@vitest/coverage-v8':
        specifier: ^1.2.0
        version: 1.6.1(vitest@1.6.1(@types/node@20.19.37))
      vitest:
        specifier: ^1.2.0
        version: 1.6.1(@types/node@20.19.37)
...
snapshots:
  ...
  '@vitest/coverage-v8@1.6.1(vitest@1.6.1(@types/node@20.19.37))':
    dependencies:
      '@ampproject/remapping': 2.3.0
      '@bcoe/v8-coverage': 0.2.3
      debug: 4.4.3
  ...
  tsup@8.5.1(postcss@8.5.8)(tsx@4.21.0)(typescript@5.9.3)(yaml@2.8.2):
    dependencies:
      bundle-require: 5.1.0(esbuild@0.27.3)
      cac: 6.7.14
      chokidar: 4.0.3
